...
const StandardList = () => {
      ...
      if (result.isConfirmed) {
        try {
          ...
          Swal.fire({
            ...
            text:
              error.message || "An error occurred while deleting the standard.",
            icon: "error",
            confirmButtonColor: theme.palette.primary.main,
          });
        }
  ...
  const getPaginatedData = () => {
    return filteredStandards.slice(
      page * rowsPerPage,
        ...
        >
          ...
          >
            {filteredStandards.length === 0
              ? "No standards found"
              : `Showing ${filteredStandards.length} standard${
                ...
                >
                  <CardContent sx={{ pb: 1 }}>
                    ...
                    <Box sx={{ mt: 1.5 }}>
                      ...
                      {standard.subjects &&
                      Array.isArray(standard.subjects) &&
                  ...
                  >
                    <Tooltip title="View Details">
                      <IconButton
                        size="small"
                        onClick={() =>
                          navigate(`/app/standards/${standard._id}`)
                        }
                        sx={{
                          color: "primary.main",
                    ...
                    <Tooltip title="Edit">
                      <IconButton
                        size="small"
                        onClick={() =>
                          navigate(`/app/standards/${standard._id}/edit`)
                        }
                        sx={{
