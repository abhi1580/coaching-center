...
const AnnouncementView = () => {
  ...
  const { currentAnnouncement, loading } = useSelector(
  ...
  const currentStatus = currentAnnouncement
    ? calculateCurrentStatus(currentAnnouncement)
    : "";
        ...
        <>
          ...
          <Paper
            ...
            sx={{
              ...
              mb: 4,
              boxShadow: (theme) =>
                `0 3px 10px ${alpha(theme.palette.primary.main, 0.08)}`,
            }}
          >
            <Box
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} md={6}>
                <Box sx={{ mb: 3 }}>
                  ...
                  >
                    {formatDate(
                      announcementData.startDate || announcementData.startTime
                    )}
                    <Chip
                      label="00:00"
                      size="small"
              ...
              <Grid item xs={12} md={6}>
                <Box sx={{ mb: 3 }}>
                  ...
                  >
                    {formatDate(
                      announcementData.endDate || announcementData.endTime
                    )}
                    <Chip
                      label="23:59"
                      size="small"
              ...
              <Grid item xs={12} md={6}>
                <Box sx={{ mb: 3 }}>
                  ...
                  >
                    ...
                    >
                      {(announcementData.createdBy?.name ||
                        "User")[0].toUpperCase()}
                    </Box>
