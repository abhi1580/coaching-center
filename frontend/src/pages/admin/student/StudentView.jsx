                            ...
                            <Stack spacing={2}>
                                ...
                                >
                                    ...
                                    <Box>
                                        ...
                                        <Typography variant="body1">
                                            {getRelatedData(
                                                selectedStudent.standard?._id || selectedStudent.standard,
                                                standards
                                            )?.name || "Not assigned"}
                                        </Typography>
                                    </Box>
                    ...
                    <Card sx={{ borderRadius: 2 }}>
                        <CardContent>
                            ...
                            {selectedStudent.batches && selectedStudent.batches.length > 0 ? (
                                <TableContainer component={Paper} sx={{ boxShadow: "none", border: `1px solid ${alpha(theme.palette.divider, 0.2)}` }}>
                                    <Table>
                                        <TableHead sx={{ bgcolor: alpha(theme.palette.primary.light, 0.05) }}>
                                            <TableRow>
                                                    ...
                                                    <TableRow key={batchData._id}>
                                                        ...
                                                        <TableCell>
                                                            ...
                                                            <Typography variant="caption" display="block" color="text.secondary">
                                                                {batchData.schedule?.startTime && batchData.schedule?.endTime
                                                                    ? `${formatTime(batchData.schedule.startTime)} - ${formatTime(batchData.schedule.endTime)}`
                                                                    : "No time specified"}
                                                            </Typography>
                                                        </TableCell>
                                                        <TableCell>
                                                        ...
                                                        <TableCell align="right">
                                                            <Tooltip title="View Batch Details">
                                                                <IconButton
                                                                    size="small"
                                                                    onClick={() => navigate(`/app/batches/${batchData._id}`)}
                                                                >
