          ...
          <Box>
            ...
            <Box sx={{ display: "flex", alignItems: "center", mt: 1 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                {Number(currentTeacher.experience) === 1 ? "year" : "years"} of
                experience
              </Typography>
            </Box>
          </Box>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      currentTeacher.gender
                        ? currentTeacher.gender.charAt(0).toUpperCase() +
                          currentTeacher.gender.slice(1)
                        : "N/A"
                    }
                  />
                </ListItem>
            ...
            <CardContent>
              ...
              <List disablePadding>
                ...
                <ListItem sx={{ py: 1, px: 0 }}>
                  ...
                  <ListItemText
                    primary="Experience"
                    secondary={`${currentTeacher.experience || "0"} ${
                      Number(currentTeacher.experience) === 1 ? "year" : "years"
                    }`}
                  />
                </ListItem>
                <ListItem sx={{ py: 1, px: 0 }}>
        ...
        <Grid item xs={12}>
          <Card sx={{ borderRadius: 2 }}>
            <CardContent>
              ...
              {Array.isArray(currentTeacher.subjects) &&
